...
export default function CredentialTypeIndex({ types }: Props) {
    ...
    const openEdit = (item: CredentialType) => {
        setEditing(item);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (editing) {
            form.put(`/admin/credential-types/${editing.id}`, {
            ...
            form.post(`/admin/credential-types`, {
    ...
    const handleDelete = (item: CredentialType) => {
        confirm({
        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">CredentialTypes</h1>
                        <p className="text-muted-foreground">Manage CredentialTypes.</p>
                    </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{editing ? 'Edit' : 'Add'} CredentialType</DialogTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_id} onChange={e => form.setData('name_id', e.target.value)} required placeholder="Contoh: Sertifikat Profesional" />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_en} onChange={e => form.setData('name_en', e.target.value)} required placeholder="Example: Professional Certificate" />
