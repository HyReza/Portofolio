...
export default function ProjectCategoryIndex({ categories }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (editing) {
            form.put(`/admin/project-categories/${editing.id}`, {
    ...
    const handleDelete = (item: ProjectCategory) => {
        confirm({
        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">ProjectCategorys</h1>
                        <p className="text-muted-foreground">Manage ProjectCategorys.</p>
                    </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{editing ? 'Edit' : 'Add'} ProjectCategory</DialogTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_id} onChange={e => form.setData('name_id', e.target.value)} required placeholder="Contoh: Proyek Pribadi" />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_en} onChange={e => form.setData('name_en', e.target.value)} required placeholder="Example: Personal Project" />
