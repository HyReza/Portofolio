...
export default function CertificateCategoryIndex({ categories }: Props) {
    ...
    const openEdit = (item: CertificateCategory) => {
        setEditing(item);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (editing) {
            ...
            form.post(`/admin/certificate-categories`, {
    ...
    const handleDelete = (item: CertificateCategory) => {
        confirm({
            title: 'Delete CertificateCategory?',
        ...
        <AppLayout>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">CertificateCategorys</h1>
                        <p className="text-muted-foreground">Manage CertificateCategorys.</p>
                    </div>
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>{editing ? 'Edit' : 'Add'} CertificateCategory</DialogTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_id} onChange={e => form.setData('name_id', e.target.value)} required placeholder="Contoh: Pengembangan Web" />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input value={form.data.name_en} onChange={e => form.setData('name_en', e.target.value)} required placeholder="Example: Web Development" />
